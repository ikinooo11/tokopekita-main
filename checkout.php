	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>MARCHANDISE HASIL KARYA MAMA PAPUA, BELANJA SEKARANG!</p>
			</div>
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di Mapua</span></h1>
