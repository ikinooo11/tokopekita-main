	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>MERCHANDISE HASIL KARYA MAMA PAPUA  <a href="products.html">BELANJA SEKARANG!</a></p>
			</div>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : (+62822) 4848 333</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">MAPUA</a></h1>
			</div>
